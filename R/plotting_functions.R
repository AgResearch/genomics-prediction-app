...
# Updated Plotting functions for Genomic Prediction Shiny App - Remove PC prefix

# PCA plotting function (unchanged)
...
# Create combined PCA plot (unchanged)
...
# Create PCA summary text (unchanged)
...
# UPDATED: Plotting function for methane group (main analysis) - Remove PC prefix
plot_combined_metrics_separate <- function(df) {
  ...
  # Create labels without PC prefix
  pc_labels <- c("G", "GM", "88", "333", "640", "933")
  names(pc_labels) <- desired_levels
...
# UPDATED: Plotting function for RFI group (main analysis) - Remove PC prefix
plot_combined_metrics_separate_rfi <- function(df) {
  ...
  # Create labels without PC prefix
  pc_labels <- c("G", "GM", "74", "299", "600", "889")
  names(pc_labels) <- desired_levels
...
# Microbiability plotting function (unchanged)
...
# Microbiability summary function (unchanged)
...
# Keep all other plotting functions unchanged (GM Model functions, supplementary figures, etc.)
# ... [All remaining functions stay exactly the same as in the original file]
...
# All remaining functions from the original file should be included here
# (create_trait_plot, create_scatter_plot, create_overlay_plot, etc.)
# For brevity, I'm indicating they should be copied from the original file
